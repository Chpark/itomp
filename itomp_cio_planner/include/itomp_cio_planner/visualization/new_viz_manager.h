...
public:
    ...
    void animateCenterOfMass(const ItompTrajectoryConstPtr& trajectory, std::vector<RigidBodyDynamics::Model>& models);
...
private:
    ...
    ros::Publisher vis_marker_array_publisher_center_of_mass_;
