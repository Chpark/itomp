...
void ImprovementManager::updatePlanningParameters()
{
...
void ImprovementManager::initializeRollouts()
{
...
void ImprovementManager::initializeCosts()
{
...
void ImprovementManager::initializeNoiseGenerators()
{
...
bool ImprovementManager::preAllocateTempVariables()
{
	tmp_noise_.clear();
...
void ImprovementManager::runSingleIteration(int iteration)
{
...
bool ImprovementManager::generateRollouts(const std::vector<double>& noise_stddev,
...
bool ImprovementManager::setRolloutCosts()
{
	for (int r = 0; r < num_rollouts_; ++r)
	{
...
void ImprovementManager::computeUpdates()
{
...
bool ImprovementManager::computeRolloutCumulativeCosts()
{
...
bool ImprovementManager::computeRolloutProbabilities()
{
	for (int d = 0; d < num_dimensions_; ++d)
	{
...
bool ImprovementManager::computeParameterUpdates()
{
	for (int d = 0; d < num_dimensions_; ++d)
	{
...
bool ImprovementManager::updateParameters()
{
	double divisor = 1.0;
	for (int d = 0; d < num_dimensions_; ++d)
	{
...
void ImprovementManager::getParameters()
{
...
void ImprovementManager::addExtraRollout(std::vector<Eigen::VectorXd>& parameters,
...
bool ImprovementManager::computeNoise(Rollout& rollout)
{
	for (int d = 0; d < num_dimensions_; ++d)
	{
...
bool ImprovementManager::computeProjectedNoise(Rollout& rollout)
{
	for (int d = 0; d < num_dimensions_; ++d)
	{
